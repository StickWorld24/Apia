...
var params = {
	...
	dataToSign : [],
	signatureVersion: "<%=Configuration.EXTENSIONS_SIGNATURE_VERSION.get("chrome")%>"
};
...
setInterval(function() {
	...
	if(btnConf && !btnConf.get('processed')) {
		...
		btnConf.addEvent('click',cofirmTask);
	}
	...
	if(btnExit && !btnExit.get('processed')) {
		...
		//btnExit.addEvent('click',closeSign);
	}
