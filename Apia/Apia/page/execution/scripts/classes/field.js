...
var Field = new Class({
	...
	parseXMLposition: function(auxContainer) {
		...
		if(this.content == null) {
			...
			var maxWidth = this.form.cols == this.cols;
	...
	addTranslationIcon: function(input, icon_container) {
		...
		if(input.hasClass('datePicker')) return;		
...
Field.PROPERTY_MODAL_DISABLED 			= "modalDisabled";
...
Field.PROPERTY_NOT_PRINT				= "noPrint";
...
Field.PROPERTY_DOCUMENT_MONITOR_DEF		= "documentMonitorDef";
Field.PROPERTY_DOCUMENT_MONITOR_CUS		= "documentMonitorCus";
Field.PROPERTY_DOCUMENT_SHOW_FOLD_TREE_BTN	= "fileShwFoldTreeBtn";
Field.PROPERTY_DOCUMENT_SHOW_FOLD_TREE_STR	= "fileShwFoldTreeStr";
Field.PROPERTY_DOCUMENT_NO_ALLOW_DRAG_DROP	= "fileNoAllwDnD";
Field.PROPERTY_DOCUMENT_NO_SHOW_MODAL	= "fileDntShwDocMdlOnDrop";
Field.PROPERTY_DOCUMENT_SHOW_DESC		= "fileShowDesc";
Field.PROPERTY_DOCUMENT_DEFAULT_FOLDER	= "fileDefFolder";
Field.PROPERTY_DOCUMENT_ROOT_FOLDER		= "fileRootFolder";
Field.PROPERTY_DOCUMENT_EXP_DATE		= "fileExpDate";
Field.PROPERTY_DOCUMENT_DNT_SHW_DOC_MON	= "fileNotShowDocMon";
Field.PROPERTY_DOCUMENT_COLLAPSE_PERM	= "fileCollapsePermission";
Field.PROPERTY_DOCUMENT_COLLAPSE_META	= "fileCollapseMetadata";
Field.PROPERTY_DOCUMENT_COLLAPSE_FLD_STC= "fileCollapseFldStrc";
