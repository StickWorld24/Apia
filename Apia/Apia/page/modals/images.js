	...
	if (ajaxCallXml != null) {
		...
		if (images != null && images.length > 0 && images.item(0) != null) {
			...
			for(var i = 0; i < images.length; i++) {
				...
				new Element('div', {'html': name, 'class': 'imgName text-truncated'}).inject(element);
				new Element('div', {'html': description, 'class': 'imgDescription text-truncated'}).inject(element);
