<%@page import="com.apia.core.CoreFacade"%><%@page import="biz.statum.apia.web.bean.BasicBeanStatic"%><%@ taglib prefix="system"	uri="/WEB-INF/system-tags.tld" %><%@page import="com.st.util.labels.LabelManager"%><%@page import="com.dogma.UserData"%><%@page import="java.util.Iterator"%><%@page import="java.util.Base64"%><%@page import="com.dogma.Parameters"%><%@page import="java.util.HashMap"%><%@page import="biz.statum.sdk.util.StringUtil"%><%@page import="com.dogma.DogmaException"%><%@page import="com.st.util.log.Log"%><html lang="<%=BasicBeanStatic.getUserDataStatic(request).getLangCode()%>" style="overflow: hidden;" ><head><%
...
// 					"<button type='button' id='btnNext' disabled='true' style='display:none;' onclick='btnNext_click()' title='" + LabelManager.getToolTip(labelSet,"btnNextSign") + "'>" + LabelManager.getName(uData,"btnNextSign") + "</button>" +
		...
		strApplet.append("</center>");
		strApplet.append("<p style='text-align:right'><a href='#' onclick='window.parent.appletCloser();return false;'>Close [x]</a></p>");
