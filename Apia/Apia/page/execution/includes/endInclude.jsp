<!-- Aca se van a buscar las excepciones que hayan existido en el serverpara mostrarlas en pantalla --><%@page import="biz.statum.sdk.util.HttpServletRequestResponse"%><label for="execErrors">&nbsp;</label><textarea id="execErrors" style="display:none" title="<system:label show="text" label="txtAnaErrors" />"><%
