function initPage(){
	...
	var btnProFin = $('btnProFin');
	if (btnProFin) {
		btnProFin.addEvent('click', function(evt) {
			if (evt)
				evt.stop;
						...
						function(con) {
							if (con) {
								var request = new Request({
									method: 'post',
									url: CONTEXT + URL_REQUEST_AJAX + '?action=confirmFinalize&isAjax=true&id=' + id + TAB_ID_REQUEST,
