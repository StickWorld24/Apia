...
// 	 			},3000);
		...
		</style></head><body onload="init()"><div id="bodyDiv"><div class="outer"><div class="middle"><div class="inner"><div class="message"><%=request.getParameter("messageText")%></div></div></div></div></div></body></html>
