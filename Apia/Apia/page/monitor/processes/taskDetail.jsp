...
out.clear();
%><region:render template='<%=template%>'><region:put section='title'><%if(proInstVo.getProPriority() != null && proInstVo.getProPriority().intValue() == com.dogma.vo.ProInstanceVo.PRO_PRIORITY_LOW){ %><img title="<system:label show="text" label="lblEjeTitPriPro1"/>" alt="<system:label show="text" label="lblEjeTitPriPro1"/>" src="<system:util show="context" />/css/base/img/priority1.gif"  ><%}else if(proInstVo.getProPriority() != null && proInstVo.getProPriority().intValue() == com.dogma.vo.ProInstanceVo.PRO_PRIORITY_HIGH){ %><img title="<system:label show="text" label="lblEjeTitPriPro3"/>" alt="<system:label show="text" label="lblEjeTitPriPro3"/>" src="<system:util show="context" />/css/base/img/priority3.gif" ><%}else if(proInstVo.getProPriority() != null && proInstVo.getProPriority().intValue() == com.dogma.vo.ProInstanceVo.PRO_PRIORITY_URGENT){%><img title="<system:label show="text" label="lblEjeTitPriPro4"/>" alt="<system:label show="text" label="lblEjeTitPriPro4"/>" src="<system:util show="context" />/css/base/img/priority4.gif"  ><%}else if(proInstVo.getProPriority() != null && proInstVo.getProPriority().intValue() == com.dogma.vo.ProInstanceVo.PRO_PRIORITY_NORMAL){%><img title="<system:label show="text" label="lblEjeTitPriPro2"/>" alt="<system:label show="text" label="lblEjeTitPriPro2"/>"src="<system:util show="context" />/css/base/img/priority2.gif" ><%}else {%><img title="<system:label show="text" label="lblEjeTitPriPro2"/>" alt="<system:label show="text" label="lblEjeTitPriPro2"/>" src="<system:util show="context" />/css/base/img/priority2.gif"  ><%}%><span id="titleSpan"><%= fromProcess ? com.st.util.StringUtil.escapeHTML(dBean.getProNameDetails()) : BeanUtils.fmtHTML(TranslationManager.getTaskTitle(dBean.getCurrentElement(), uData.getEnvironmentId(), uData.getLangId())) %></span></region:put><region:put section="tskDescription"><%=fromProcess ? com.st.util.StringUtil.escapeHTML(dBean.getProInstanceBean().getProcess().getProDesc()) : BeanUtils.fmtHTML(TranslationManager.getTaskDescription(dBean.getTaskVo().getTskName(), dBean.getTaskVo().getTskDesc(), uData.getEnvironmentId(), uData.getLangId())) %>
		&nbsp;</region:put><region:put section="taskImage"><%if(fromProcess) {%><%if(dBean.getProInstanceBean().getProcess().getImgPath() != null){%><img src="<system:util show="context" />/images/uploaded/<%=dBean.getProInstanceBean().getProcess().getImgPath()%>" style="height: 64px; width: 64px;"><%} else {%><img src="<system:util show="context" />/css/base/img/functionalities/Procesos.gif" style="height: 64px; width: 64px;"><%} %><%} else { %><%if(dBean.getTaskVo().getImgPath()!=null){%><img src="<system:util show="context" />/images/uploaded/<%=dBean.getTaskVo().getImgPath()%>" style="height: 64px; width: 64px;"><%} else {%><img src="<system:util show="context" />/css/base/img/functionalities/Tareas.gif" style="height: 64px; width: 64px;"><%} %><%} %></region:put><region:put section='entityMain'><%@include file="/page/execution/includes/entityMain.jsp" %></region:put><region:put section='entityDocuments' content="/page/execution/includes/documents.jsp?frmParent=E"/><region:put section='processMain'><%@include file="/page/execution/includes/processMain.jsp" %></region:put><region:put section='processDocuments' content="/page/execution/includes/documents.jsp?frmParent=P"/><region:put section='entityForms'><div class="tabContent"><%
