/*
 * masked-input.js
 * Mascaras para campos input
 */

var MaskedInput = {};

/**
 * Establece la mascara para un campo input.
 * @param input campo input sobre el que se aplicara la mascara
 * @param mask mascara a colocar en input
 */
MaskedInput.setMask = function (input, mask) {
	...
	//Colocar listener en el onblur del elemento. Cuando tiene el foco deberaa mostrarse la mascara
...
/**
 * Remueve la mascara para un campo input.
 * @param input campo input sobre el que se quitara la mascara
 */
...
MaskedInput.mask = function(input) {
	...
	input.set('data-focusValue',new_value);
}
...
MaskedInput.endMask = function(input) {
	...
	if(inputVal!=input.get('data-empty_mask') && unmasked_value.length == input.get('data-empty_mask').length && input.get('data-focusValue')!=inputVal) {
