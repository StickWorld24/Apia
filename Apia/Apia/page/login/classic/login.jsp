...
<region:render template='<%=template%>'>
	...
	<region:put section='javascriptVariables'>
		...
		var referralUrl = '<%=request.getParameter("referralURL")%>';
				...
				<div class="loginContainer">
					...
					<c:if test="${showGenPwd=='true'}">
						<div class="section  loginRemember">
							<a href="#" id="loginRemember" title="<system:label show="tooltip" label="btnFgtPwd" />"><system:label show="text" label="btnFgtPwd" /></a>
						</div>
					</c:if>
