	...
	style="<system:edit show="value" from="theBean" field="tblModValue">style='display:none'</system:edit>"><div class="field fieldTwoFifths"><label
		...
		<system:edit show="ifNotFlag" from="theEdition" field="3" >style='display:none'</system:edit>><system:edit show="ifFlag" from="theEdition" field="3"><system:edit show="value" from="theBean"
			...
			class="label"><system:label show="text"
				...
				field="selQryColIdModTextParam"  avoidHtmlConvert="true"/></system:edit><system:edit show="ifNotFlag" from="theEdition" field="3"><input type="hidden" value="-1" name="selQryColIdModTextParam"></system:edit></div></div><system:edit show="ifValue" from="theEdition" field="qryType" value="T"><div class="fieldGroup splitTable"><div class="field fieldOneThird"><label
				title="<system:label show="tooltip" label="lblReloadTab" />"
				for="lblReloadTab" class="label"><system:label
					show="text" label="lblReloadTab" />:&nbsp;</label><input
				type="checkbox" id="chkReloadTab" name="chkReloadTab"
				<system:edit show="ifFlag" from="theEdition" field="24" >checked</system:edit>
				style="width: 30px !important;"></div></div></system:edit>
