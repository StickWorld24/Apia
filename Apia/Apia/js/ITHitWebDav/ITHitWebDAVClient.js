...
ITHit.DefineClass('ITHit.WebDAV.Client.Methods.MultiResponse', null, /** @lends ITHit.WebDAV.Client.Methods.MultiResponse.prototype */{
	...
	constructor: function(oXmlDoc, sOriginalUri) {
		...
		if ((oNode = oPagingRes.iterateNext())) {
		    this.PagingTotal = parseInt(oNode.firstChild().nodeValue());
		}
 ...
 * the operation as well as you will use it to get the results of the asynchronous call.
 * @api
 * @class ITHit.WebDAV.Client.PagingAsyncResult
 */
ITHit.DefineClass('ITHit.WebDAV.Client.PagingAsyncResult', ITHit.WebDAV.Client.AsyncResult, /** @lends ITHit.WebDAV.Client.PagingAsyncResult.prototype */{
	 ...
	 * @param {*} oResult
	 * @param {boolean} bSuccess
     * @param {number} nPagingTotal
	 * @param {ITHit.WebDAV.Client.Exceptions.WebDavException|Error|null} oError
	 */
    constructor: function (oResult, bSuccess, oError) {
        this._super(oResult, bSuccess, oError);
        this.PagingTotal = oResult != null ? oResult.PagingTotal : null;      
    }
...
ITHit.DefineClass('ITHit.WebDAV.Client.OrderProperty', null, /** @lends ITHit.WebDAV.Client.OrderProperty.prototype */{
	 ...
	 * @param {boolean} sNamespaceUri Namespace of the property.
	 */
...
ITHit.DefineClass('ITHit.WebDAV.Client.Methods.Propfind', ITHit.WebDAV.Client.Methods.HttpMethod, /** @lends ITHit.WebDAV.Client.Methods.Propfind.prototype */{
    ...
    __static: /** @lends ITHit.WebDAV.Client.Methods.Propfind */{
        ...
        _GoCallback: function (oRequest, sUri, oResult, fCallback) {
            ...
            if (typeof fCallback === 'function') {
                ...
                var oPropfindResult = new ITHit.WebDAV.Client.PagingAsyncResult(oPropfind, bSuccess, oError);
   ...
   */
    constructor: function (oResponse) {
        ...
        this.PagingTotal = oResponse.PagingTotal;
    }
});
...
(function() {
    ...
    var self = ITHit.DefineClass('ITHit.WebDAV.Client.DocManager', null, {
        __static: /** @lends ITHit.WebDAV.Client.DocManager */{
			 ...
			 * Obsolete. Please use <code>GetProtocolInstallFileNames</code> instead
			 */
            ...
            */
             ...
             * @param {string} [sCookieNames] <span class="optional">v3 Beta and later only.</span> Coma separated list of cookie names to search for. If this parameter is not specified - copies all cookies from a current web browser.  Microsoft Office requires persistent cookie (with expiration date), it does not support session cookies.
            ...
            CallFirefoxExtension: function (uri, errorCallback) {
                // Create unique response id
                var responseString = ITHit.WebDAV.Client.WebDavUtil.HashCode(location.href) + '_OpenUriUsingFirefoxExtension_Response';
...
(function() {
    ...
    var self = ITHit.DefineClass('ITHit.WebDAV.Client.Folder', ITHit.WebDAV.Client.HierarchyItem, /** @lends ITHit.WebDAV.Client.Folder.prototype */{
         ...
         * @param {ITHit.WebDAV.Client.PagingAsyncResult} oResult Result object
         * @param {ITHit.WebDAV.Client.HierarchyItem[]} oResult.Result Array of file and folder objects.
         */

        /**
         * Get children of ITHit.WebDAV.Client.Folder folder that supports paging and sorting. If boolean parameter is set to false only children of this folder are requested.
         * Otherwise the entire subtree is requested.
         * @api
         * @param {boolean} bRecursively Indicates if all subtree of children should be return. Default is false.
         * @param {ITHit.WebDAV.Client.PropertyName[]} aProperties Additional properties requested from server. Default is empty array.         
         * @param {number} offset The number of items to skip before returning the remaining items. Start listing from from next item. Default is null
         * @param {number} nResults The number of items to return. Default is null.
         * @param {ITHit.WebDAV.Client.OrderProperty[]} aOrderProperties List of order properties. Default is empty array
         * @param {ITHit.WebDAV.Client.Folder~GetPageAsyncCallback} fCallback Function to call when operation is completed.
         * @returns {ITHit.WebDAV.Client.Request} Request object.       
         */
        GetPageAsync: function (bRecursively, aProperties, offset, nResults, aOrderProperties, fCallback) {
            bRecursively = bRecursively || false;
            ...
            ITHit.WebDAV.Client.Methods.Propfind.GoAsync(
                ...
                offset, nResults, aOrderProperties
            );
        ...
        GetChildrenAsync: function (bRecursively, aProperties, fCallback) {
            ...
            return this.GetPageAsync(bRecursively, aProperties, null, null, null, fCallback);
        },
...
(function() {
     ...
     */
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Controls.HtmlControl',
        null,
    ...
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Utils.DavUrl',
        ...
        /** @lends ITHit.WebDAV.Client.Upload.Utils.DavUrl.prototype */ {
            ...
            constructor: function(sUrl, sBaseUrl) {
                ...
                if (this._isRelative(sUrl) && !!sBaseUrl) {
                    this._OriginalUrl = this._GetWithoutTrailingSeparator(sBaseUrl) + sUrl;
...
(function() {
    ...
    /**
     * Information for upload creation.
     * @public
     * @class ITHit.WebDAV.Client.Upload.UploadInfo
     */
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.UploadInfo',
        null,
        /** @lends ITHit.WebDAV.Client.Upload.UploadInfo.prototype */ {
            /**
             * Upload url.
            ...
            /**
             * Upload file content. Can be null if directory uploaded.
             * @type {File|null}
             */
            File: null,
            ...
            constructor: function(oDavUrl, oFile) {
                this.Url = oDavUrl;
                this.File = oFile || null;
            }
...
(function() {
    ...
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Utils.DavUrlBuilder',
        Object,
        /** @lends ITHit.WebDAV.Client.Upload.Utils.DavUrlBuilder.prototype */ {

            /**
             * Collection of path parts used ro compose DavUrl.
             * @public
             * @type {string[]}
             */
            PathParts: [],
            ...
            /**
             * Creates DavUrl object.
             * @return {ITHit.WebDAV.Client.Upload.Utils.DavUrl} Created DavUrl object.
             */
            Create: function() {
                var sFullPath = this._PathSeparator + this.PathParts.join(this._PathSeparator);
                return new ITHit.WebDAV.Client.Upload.Utils.DavUrl(sFullPath, this._BaseUrl);
            },

            /**
             * @return {ITHit.WebDAV.Client.Upload.Utils.DavUrlBuilder}
             */
            Clone: function() {
                var oBuilder = new ITHit.WebDAV.Client.Upload.Utils.DavUrlBuilder(this._BaseUrl);
                oBuilder.PathParts = this.PathParts.slice();
                return oBuilder;
            },

            /**
             * Creates and return a DavUrlBuilder object.
             * @classdesc DavUrlBuilder object providing methods used for creating DavUrl object.
             * @public
             * @class ITHit.WebDAV.Client.Upload.Utils.DavUrlBuilder
             * @constructs
             * @param {string} sBaseUrl
             */
...
(function() {
    ...
    /**
     * This class provides methods for creation of {@link ITHit.WebDAV.Client.Upload.UploadInfo}s.
     * @public
     * @class ITHit.WebDAV.Client.Upload.UploadInfoFactory
     */
    var self = ITHit.DefineClass('ITHit.WebDAV.Client.Upload.UploadInfoFactory',
        null,
        {},
        /** @lends ITHit.WebDAV.Client.Upload.UploadInfoFactory */
        {
            ...
            _ExtractFromWebkitEntriesAsync: function(aWebkitEntries, oBuilder, fCallback) {
                if (aWebkitEntries.length === 0) {
                    oBuilder.PathParts.push('');
                    var oUploadInfo = new ITHit.WebDAV.Client.Upload.UploadInfo(oBuilder.Create());
                    fCallback(new ITHit.WebDAV.Client.AsyncResult([oUploadInfo], true, null));
                }
                ...
                for (var i = 0; i < aWebkitEntries.length; i++) {
                    ...
                    self._ExtractFromWebkitEntryAsync(oWebkitEntry, oBuilder.Clone(), function(oAsyncResult) {
                        iIterations--;
                        if (!oAsyncResult.IsSuccess) {
                            iIterations = 0;
                            fCallback(oAsyncResult);
                        ...
                        if (iIterations <= 0) {
                            fCallback(new ITHit.WebDAV.Client.AsyncResult(aEntries, true, null));
                        }
                    });
                }
            },
             ...
             *
             * @param {string} sUrl
             * @return {ITHit.WebDAV.Client.Upload.UploadInfo[]}
             * @param {FileList} aFiles
             */
            CreateFromFileList: function(aFiles, sUrl) {
                var oUploadInfos = [];
                for (var i = 0; i < aFiles.length; i++) {
                    var oFile = aFiles[i];
                    var sRelativePath = oFile.webkitRelativePath || oFile.name;
                    var oUrl = new ITHit.WebDAV.Client.Upload.Utils.DavUrl('/' + sRelativePath, sUrl);
                    var oUploadInfo = new ITHit.WebDAV.Client.Upload.UploadInfo(oUrl, oFile);
                    oUploadInfos.push(oUploadInfo);
                }
                return oUploadInfos;
            },
            /**
             ...
             * @param {ITHit.WebDAV.Client.Upload.UploadInfoFactory~ResultCallback} fCallback
             */
            CreateFromInputAsync: function(oInput, sUrl, fCallback) {
                if (sUrl.length && (sUrl.slice(-1) !== '/')) {
                    sUrl += '/';
                }
                if (!!oInput.webkitEntries && oInput.webkitEntries.length > 0) {
                    var aWebkitEntries = this._GetWebkitEntries(oInput.webkitEntries.items);
                    if (aWebkitEntries.length > 0) {
                        var oBuilder = new ITHit.WebDAV.Client.Upload.Utils.DavUrlBuilder(sUrl);
                        self._ExtractFromWebkitEntriesAsync(aWebkitEntries, oBuilder, function(oAsyncResult) {
                            fCallback(oAsyncResult);
                        });
                        return;
                    }
                ...
                var oUploadInfos = this.CreateFromFileList(oInput.files, sUrl);
                fCallback(new ITHit.WebDAV.Client.AsyncResult(oUploadInfos, true, null));
            },
             ...
             * @param {ITHit.WebDAV.Client.Upload.UploadInfoFactory~ResultCallback} fCallback
             */
            CreateFromDataTransferAsync: function(oDataTransfer, sUrl, fCallback) {
                if (sUrl.length && (sUrl.slice(-1) !== '/')) {
                    sUrl += '/';
                }
                ...
                if (oDataTransfer.files.length > 0) {
                    aResult = self.CreateFromFileList(oDataTransfer.files, sUrl);
                }

                fCallback(new ITHit.WebDAV.Client.AsyncResult(aResult, true, null));
            },

            _ExtractFromWebkitEntryAsync: function(oEntry, oBuilder, fCallback) {
                if (oEntry.isDirectory) {
                    self._ExtractWebkitDirectoryChildrenAsync(oEntry, oBuilder.Clone(), function(oAsyncResult) {
                        if (oAsyncResult.IsSuccess) {
                            fCallback(oAsyncResult);
                        } else {
                            fCallback(new ITHit.WebDAV.Client.AsyncResult(oAsyncResult.Result, true, null));
                        }
                    });
                } else {
                    oEntry.file(function(file) {
                        oBuilder.PathParts.push(file.name);
                        var oUploadInfo = new ITHit.WebDAV.Client.Upload.UploadInfo(oBuilder.Create(), file);
                        fCallback(new ITHit.WebDAV.Client.AsyncResult(oUploadInfo, true, null));
                    }, function(oFileError) {
                        fCallback(new ITHit.WebDAV.Client.AsyncResult(null, false, oFileError));
                    });
                }
            },

            _ExtractWebkitDirectoryChildrenAsync: function(oWebKitDirectory, oBuilder, fCallback) {
                var dirReader = oWebKitDirectory.createReader();
                dirReader.readEntries(function(entries) {
                    oBuilder.PathParts.push(oWebKitDirectory.name);
                    self._ExtractFromWebkitEntriesAsync(entries, oBuilder, fCallback);
                }, function errorHandler(oException) {
                    fCallback(new ITHit.WebDAV.Client.AsyncResult(null, false, oException));
                });
            }
        }
    );
 ...
 * @callback ITHit.WebDAV.Client.Upload.UploadInfoFactory~ResultCallback
 * @param {ITHit.WebDAV.Client.AsyncResult} oAsyncResult Result of creation. Contains array of {@link ITHit.WebDAV.Client.Upload.UploadInfo}s.
 *
 */
...
(function() {
    ...
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Controls.DropZone',
        ...
        /** @lends  ITHit.WebDAV.Client.Upload.Controls.DropZone.prototype */ {
            ...
            /**
             * The Uploader is associated with.
             * @type {ITHit.WebDAV.Client.Upload.Uploader }
             */
            Uploader: null,

            constructor: function(oUploader, sElementId) {
            ...
            _OnDropHandler: function(oEvent) {
                ...
                var that = this;
                ITHit.WebDAV.Client.Upload.UploadInfoFactory.CreateFromDataTransferAsync(oEvent.dataTransfer, this._Uploader.GetUploadUrl(), function(oAsyncResult) {
                    that._Uploader.Queue.AddFilesToQueue(oAsyncResult.Result, that);
                });
            },
    ...
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Controls.Input',
        ...
        /** @lends  ITHit.WebDAV.Client.Upload.Controls.Input.prototype */ {
            ...
            _OnChange: function(oEvent) {
                ...
                this._StopEvent(oEvent);
                var that = this;
                ITHit.WebDAV.Client.Upload.UploadInfoFactory.CreateFromInputAsync(oEvent.target, this._Uploader.GetUploadUrl(), function(oAsyncResult) {
                    that._Uploader.Queue.AddFilesToQueue(oAsyncResult.Result, that);
                    oEvent.target.value= '';
                });
            }
...
(function() {
    ...
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Providers.ProgressDescriptor',
        null,
        /** @lends ITHit.WebDAV.Client.Upload.Providers.ProgressDescriptor.prototype */
        {
            ...
            /**
             * Provides addition data for upload process.
             * @class ITHit.WebDAV.Client.Upload.Providers.ProgressDescriptor
             * @constructs
             * Create new task.
             * @public
             * @param {string} sUrl The url of progress
             * @param {number} iSize The total size of upload.
             */
            constructor: function(sUrl, iSize) {
                this.Url = sUrl;
                this.Size = iSize;
             ...
             * @param {Date} [oDate]
             */
            Reset: function(oDate) {
                var oNow = oDate || new Date();
        ...
        /** @lends ITHit.WebDAV.Client.Upload.Collections.Map.prototype */
        {
            ...
            Entries: function() {
                ...
                for (var i = 0; i < aKeys.length; i++) {
                    var sKey = aKeys[i];
                    aKeys.push(new ITHit.WebDAV.Client.Upload.Collections.Pair(sKey, this._UnderLayingObject[sKey]));
                }
...
(function() {
    ...
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Providers.ProgressTracker',
        ...
        /** @lends ITHit.WebDAV.Client.Upload.Providers.ProgressTracker.prototype */
        {
            /**
             * @private
             * @type {ITHit.WebDAV.Client.Upload.Providers.ProgressDescriptor}
             */
            _Descriptor: null,
             ...
             * @public
             * @class ITHit.WebDAV.Client.Upload.Providers.ProgressTracker
             * @classdesc Provides methods for perform progress tracking. Tracking performed by url.
             * @constructs
             * @param {ITHit.WebDAV.Client.Upload.UploaderSession} oSession The session used for request to server.
             * @param {string} sUrl Upload url
             * @param {number} iSize File size.
             */
            constructor: function(oSession, sUrl, iSize) {
                this._Session = oSession;
                this._Url = sUrl;
                this._Descriptor = new ITHit.WebDAV.Client.Upload.Providers.ProgressDescriptor(sUrl, iSize);
                this._Descriptor.CurrentProgress = new ITHit.WebDAV.Client.Upload.Progress();
                this._Descriptor.CurrentProgress.TotalBytes = iSize;
            },
            ...
            _CalculateProgress: function() {
                var iTotalFileSize = this._Descriptor.Size;
                var iUploaded = 0;
                var fUploadSpeed = 0;
                ...
                if (iTotalFileSize === 0) {
                    ...
                    var aLastDiffSlice = this._Descriptor.Diffs.slice(-1 *
                        this._DiffCount);
                    ...
                    iUploaded = Math.floor((this._Descriptor.BytesUploaded) /
                        (iTotalFileSize) * 100);
                    fUploadSpeed = iSummaryBytesUploaded / iSummaryTimeUpload;
                    fUploadSpeed = (fUploadSpeed > 0) ? fUploadSpeed : 0;
                }

                var oNewProgress = new ITHit.WebDAV.Client.Upload.Progress();
                oNewProgress.TotalBytes = iTotalFileSize;
                oNewProgress.UploadedBytes = this._Descriptor.BytesUploaded;
                oNewProgress.Speed = Math.floor((Math.round(fUploadSpeed * 10) /
                    10));
                oNewProgress.Completed = iUploaded;
                oNewProgress.ElapsedTime = Math.floor(this._Descriptor.ElapsedTime);

                if (fUploadSpeed) {
                    var iTimeLeft = Math.ceil((iTotalFileSize -
                        this._Descriptor.BytesUploaded) / fUploadSpeed);
                    oNewProgress.RemainingTime = Math.floor(iTimeLeft);
                }

                return oNewProgress;
            },
            _Notify: function() {
                var oEvent = new ITHit.WebDAV.Client.Upload.Events.ProgressChanged(this, this._Descriptor.OldProgress, this._Descriptor.CurrentProgress);
                ITHit.Events.DispatchEvent(this._Descriptor, 'OnProgress', [oEvent]);
            },
            UpdateBytes: function(iBytesUploaded, iBytesTotal) {
                var oNow = new Date();
                var iCurrentBytesUploaded = iBytesUploaded +
                    this._Descriptor.StartPosition -
                    this._Descriptor.LastUploadedBytes;
                var iTimeUpload = (oNow - this._Descriptor.LastReportTime) /
                    1000;
                var oDiffInfo = new ITHit.WebDAV.Client.Upload.Providers.UploadDiff(iCurrentBytesUploaded, iTimeUpload);
                this._Descriptor.Diffs.push(oDiffInfo);
                this._Descriptor.BytesUploaded = iBytesUploaded +
                    this._Descriptor.StartPosition;
                this._Descriptor.LastUploadedBytes = iBytesUploaded +
                    this._Descriptor.StartPosition;
                this._Descriptor.LastReportTime = oNow;
                this._Descriptor.ElapsedTime += iTimeUpload;
            ...
            _Set: function(BytesUploaded, TotalContentLength) {
                var oDescriptor = this._Descriptor;

                var oNow = new Date();
                var iTimeUpload = (oNow - oDescriptor.LastReportTime) / 1000;
                oDescriptor.Reset();
                oDescriptor.BytesUploaded = BytesUploaded;
                oDescriptor.LastUploadedBytes = 0;
                oDescriptor.LastReportTime = oNow;
                oDescriptor.ElapsedTime += iTimeUpload;
                oDescriptor.CurrentProgress = this._CalculateProgress();
                this._Notify();
            },
            UpdateFromServerAsync: function(fCallback) {
                var that = this;
                var oDescription = this._Descriptor;
                this._Session.GetProgressReportAsync(that._Url, function(oAsyncResult) {
                    if (oAsyncResult.IsSuccess && oAsyncResult.Result[0]) {
                        var oServerProgress = oAsyncResult.Result[0];
                        if (oServerProgress.BytesUploaded <
                            oDescription.StartPosition) {
                            oDescription.Reset();
                            oDescription.StartPosition = oServerProgress.BytesUploaded;
                        }

                        oServerProgress.BytesUploaded -= oDescription.StartPosition;
                        that._Set(oServerProgress.BytesUploaded, oServerProgress.TotalContentLength);
                    }
            ...
            OnProgressChanged: function(fCallback, oContext) {
                var oDescriptor = this._Descriptor;
                ITHit.Events.AddListener(oDescriptor, 'OnProgress', fCallback, oContext);
            },
             ...
             * @param {number} [iStart=0] The sturt position of the upload session.
             */
            StartTracking: function(iStart) {
                iStart = iStart || this._Descriptor.BytesUploaded;
                this._Descriptor.StartPosition = iStart;
            },
            ...
            StopTracking: function() {
                var oDescriptor = this._Descriptor;
                oDescriptor.Reset();
                oDescriptor.CurrentProgress.Speed = 0;
                this._Notify();
            },

            /**
             * Retrieves progress from server and begins track progress.
             * @public
             * @param {function} fCallback Callback to call when track starts.
             */
            StartResumableSessionAsync: function(fCallback) {
                if (this.CanUpdateFromServer() && (this.GetProgress().UploadedBytes !== 0)) {
                    this.UpdateFromServerAsync(fCallback);
                } else {
                    this.StartTracking();
                    fCallback();
                }
            ...
            /**
             * Retrieves progress from server and end track progress.
             * @param {function} fCallback Callback to call when track ends.
             */
            StopResumableSessionAsync: function(fCallback) {
...
(function() {
    ...
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.UploadItem',
        ...
        /** @lends ITHit.WebDAV.Client.Upload.UploadItem.prototype */ {
             ...
             * @private
             * @type {(ITHit.WebDAV.Client.Upload.State | string)}
             */
            _State: null,
            ...
            /**
             * Check if upload item represents Folder.
             * @return {boolean}
             */
            IsFolder: function() {
             ...
             * Set state.
             * @private
             * @param {(ITHit.WebDAV.Client.Upload.State | string)} oState
             */
            _SetState: function(oState) {
                var oldState = this._State;
                this._State = oState;
                var oEvent = new ITHit.WebDAV.Client.Upload.Events.StateChanged(this, oldState, oState);
            ...
            /**
             * @type {ITHit.WebDAV.Client.Upload.UploadInfo}
             */
            _FileInfo: null,
            ...
            constructor: function(oQueue, oFileInfo, oBinding, oUploadProvider) {
                this._FileInfo = oFileInfo;
                this._Source = oBinding || null;
                this._UploadProvider = oUploadProvider;
             ...
             * Begins upload.
             * @api
             * @param {ITHit.WebDAV.Client.Upload.UploadItem~AsyncCallback} [fCallback] The callback to call when upload paused.
             */
            StartAsync: function(fCallback) {
                fCallback = fCallback || function() { };
                this._UploadProvider.StartUploadAsync(this, this._ProgressTracker, fCallback);
            },
            ...
            PauseAsync: function(fCallback) {
                fCallback = fCallback || function() { };
                this._UploadProvider.PauseUpload(this, fCallback);
            },
             ...
             * @param {ITHit.WebDAV.Client.Upload.UploadItem~AsyncCallback} [fCallback] The callback to call when upload cancelled.
             */
            CancelAsync: function(iTryCount, iDelayAttempt, fCallback) {
                fCallback = fCallback || function() { };
                iTryCount = iTryCount || 5;
                iDelayAttempt = iDelayAttempt || 500;
                this._UploadProvider.AbortUpload(this, iTryCount, iDelayAttempt, fCallback);
            },
             ...
             */
            GetSize: function() {
                var oFile = this._FileInfo.File;
                return oFile ? (oFile.size || oFile.fileSize) : 0;
            },
            ...
            AddListener: function(sEventName, fCallback, oContext) {
                ...
                switch (sEventName) {
                    ...
                    default:
                        throw new ITHit.WebDAV.Client.Exceptions.WebDavException('Not found event name `' +
                            sEventName + '`');
                }
            },
...
(function() {
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Events.LoadStart',
        ITHit.WebDAV.Client.Upload.Events.BaseEvent,
        /** @lends ITHit.WebDAV.Client.Upload.Events.LoadStart.prototype */
        {
            /**
             * Uploaded item.
             * @public
             ...
             * This class provides state change event data;
             * @public
             * @class ITHit.WebDAV.Client.Upload.Events.LoadStart
             * @extends ITHit.WebDAV.Client.Upload.Events.BaseEvent
             * @constructs
             ...
             */
            constructor: function(oItem, ChunkStart, ChunkEnd) {
                this.Name = ITHit.WebDAV.Client.Upload.Events.EventName.OnLoadStart;
                this.Item = oItem;
                this.ChunkStart = ChunkStart || 0;
                this.ChunkEnd = ChunkEnd || this.Item.GetSize();
            }
        });
})();
...
(function() {
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Events.LoadProgress',
        ITHit.WebDAV.Client.Upload.Events.BaseEvent,
        /** @lends ITHit.WebDAV.Client.Upload.Events.LoadProgress.prototype */
        {
            /**
             * Previous state.
             * @public
            ...
            /**
             * @public
             * @class ITHit.WebDAV.Client.Upload.Events.LoadProgress
             * @extends ITHit.WebDAV.Client.Upload.Events.BaseEvent
             * @constructs
             * @param {ITHit.WebDAV.Client.Upload.UploadItem} oItem
             * @param {number} iBytesLoaded
             * @param {number} [iTotalBytes]
             * @param {Date} [oTimeStamp] The timestamp of progress.
             */
            constructor: function(oItem, iBytesLoaded, iTotalBytes) {
                this.Name = ITHit.WebDAV.Client.Upload.Events.EventName.OnLoadProgress;
                this.Item = oItem;
                this.BytesLoaded = iBytesLoaded || 0;
                this.TotalBytes = iTotalBytes || 0;
            }
        });
})();
...
(function() {
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Events.LoadError',
        ITHit.WebDAV.Client.Upload.Events.BaseEvent,
        /** @lends ITHit.WebDAV.Client.Upload.Events.LoadError.prototype */
        {
            /**
             * @public
             * @type {ITHit.WebDAV.Client.Upload.UploadItem}
             ...
             * This class provides state change event data;
             * @public
             * @class ITHit.WebDAV.Client.Upload.Events.LoadError
             * @extends ITHit.WebDAV.Client.Upload.Events.BaseEvent
             * @constructs
             * @param {ITHit.WebDAV.Client.Upload.UploadItem} oItem
             * @param {ITHit.WebDAV.Client.HttpStatus} oStatus
             * @param {string} sResponseText
             */
            constructor: function(oItem, oStatus, sResponseText) {
                this.Name = ITHit.WebDAV.Client.Upload.Events.EventName.OnLoadError;
                this.Item = oItem;
                this.Status = oStatus;
                this.Text = sResponseText;
            }
        });
})();
...
(function() {
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Events.LoadEnd',
        ITHit.WebDAV.Client.Upload.Events.BaseEvent,
        /** @lends ITHit.WebDAV.Client.Upload.Events.LoadEnd.prototype */
        {
            /**
             * @public
             * @type {ITHit.WebDAV.Client.Upload.UploadItem}
             ...
             * This class provides state change event data;
             * @public
             * @class ITHit.WebDAV.Client.Upload.Events.LoadEnd
             * @extends ITHit.WebDAV.Client.Upload.Events.BaseEvent
             * @constructs
             * @param {ITHit.WebDAV.Client.Upload.UploadItem} oItem
             * @param {ITHit.HttpResponse} oResponse
             */
            constructor: function(oItem, oResponse) {
...
(function() {
    /**
     * Class represent Base Uploader.
     * @public
     * @abstract
     * @class ITHit.WebDAV.Client.Upload.Uploaders.BaseUploader
     */
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Uploaders.BaseUploader',
        null,
        /** @lends ITHit.WebDAV.Client.Upload.Uploaders.BaseUploader.prototype */
        {
            ...
            /**
             * Init request and begin upload.
             * @public
             * @param {ITHit.WebDAV.Client.Upload.UploadItem} oUploadItem
             * @param {number} [iStartPosition=0] Offset.
             */
            BeginUpload: function(oUploadItem, iStartPosition) {
            },

            /**
             * Free and cancel request.
             * @access public
             */
            Destruct: function() {
            }
...
(function() {
    /**
     * Class represent Ajax uploader.
     * @public
     * @class ITHit.WebDAV.Client.Upload.Uploaders.BaseXhrUploader
     * @extends ITHit.WebDAV.Client.Upload.Uploaders.BaseUploader
     */
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Uploaders.BaseXhrUploader',
        ITHit.WebDAV.Client.Upload.Uploaders.BaseUploader,
        /** @lends ITHit.WebDAV.Client.Upload.Uploaders.BaseXhrUploader.prototype */
        {
            /**
             * TimeSpan of last progress event fired.
             * @private
             * @type {number}
             */
            _LastReportTime: 0,
            ...
            /**
             * Size of chunk. If '0' then load whole file.
             * @private
             * @type {number}
             * @default
             */
            ...
            /**
             * Suppress load start event handling whe upload parts except first.
             * @private
             * @type {boolean}
             * @default
             */
            ...
            constructor: function(iChunkSize) {
                this._ChunkSize = iChunkSize || 0;
            },
            ...
            BeginUpload: function(oUploadItem, iStartPosition) {
                ...
                this._ChunkStart = iStartPosition || 0;
                this.Url = oUploadItem.GetUrl();
                this.UploadItem = oUploadItem;
                this._File = oUploadItem.GetFile();
                this._InitializeXhr();
                this._BeginUploadInternal();
            },

            /**
             * Check if upload should be made by parts.
             * @return {boolean}
             * @protected
             */
            _IsPartial: function() {
                var iFileSize = this.UploadItem.GetSize();
                return (this._ChunkSize > 0 && this._ChunkSize < iFileSize) ||
                    this.UploadItem.GetProgress().UploadedBytes > 0;
            },
            ...
            _BeginUploadInternal: function() {
                ...
                if (this._IsPartial()) {
                    ...
                    if (this._ChunkEnd > iFileSize || this._ChunkSize === 0) {
                        this._ChunkEnd = iFileSize;
                    }

                    if (this._ChunkStart !== 0 || this._ChunkEnd !== iFileSize) {
                        this._Xhr.setRequestHeader(
                            'Content-Range', 'bytes ' + this._ChunkStart + '-' + (this._ChunkEnd - 1) + '/' + iFileSize);
                    }
                    if (this._ChunkEnd < iFileSize) {
            ...
            _InitializeXhr: function() {
                ...
                var sHref = ITHit.WebDAV.Client.Encoder.Encode(this.UploadItem.GetUrl());
                this._Xhr.open(this._HttpMethod, sHref, true);
                try {
            ...
            /**
             * @param {XMLHttpRequest} oXhr
             * @param {*} oEvent
             * @private
             */
            _LoadStartHandler: function(oXhr, oEvent) {
                if (!this._SkipLoadStartHandling) {
                    var oEventData = new ITHit.WebDAV.Client.Upload.Events.LoadStart(this.UploadItem, this._ChunkStart, this._ChunkEnd);
                    ITHit.Events.DispatchEvent(this, oEventData.Name, [this, oEventData]);
                }
            },

            _FireProgressChanged: function(iBytesUploaded) {
                var oEventData = new ITHit.WebDAV.Client.Upload.Events.LoadProgress(this.UploadItem, iBytesUploaded, this.UploadItem.GetSize());
                ITHit.Events.DispatchEvent(this, oEventData.Name, [this, oEventData]);
            }, /**
         *
         * @param {XMLHttpRequest} oXhr
         ...
         * @private
         */
        _ProgressHandler: function(oXhr, oEvent) {
            ...
            var iBytesUploaded = oEvent.loaded;
            this._FireProgressChanged(iBytesUploaded);
        },
             ...
             * @private
             */
            _ReadyStateChange: function(oXhr, oEvent) {
                if (this._Xhr.readyState !== 4) {
                    return;
                }
                var oStatus = new ITHit.WebDAV.Client.HttpStatus(this._Xhr.status, this._Xhr.statusText);

                if (oStatus.IsSuccess()) {
                    this._LoadHandler(oXhr, oEvent);
                } else {
                    this._ErrorHandler(oXhr, oEvent, oStatus);
                }
            },
             ...
             * @private
             */
            _ErrorHandler: function(oXhr, oEvent, oStatus) {
                var oEventData = new ITHit.WebDAV.Client.Upload.Events.LoadError(this, oStatus, oXhr.responseText);
                ITHit.Events.DispatchEvent(this, oEventData.Name, [this, oEventData]);
            },

            /**
             * @param {XMLHttpRequest} oXhr
             * @return {ITHit.HttpResponse}
             * @private
             */
            _CreateResponse: function(oXhr) {
                var oStatus = new ITHit.WebDAV.Client.HttpStatus(oXhr.status, oXhr.statusText);
                var oResponse = new ITHit.HttpResponse(this.Url, oStatus.Code, oStatus.Description);
                oResponse._SetBody(oXhr.responseXML, oXhr.responseText);
                return oResponse;
            },

            IsLastPart: function() {
                return this._ChunkEnd &&
                    this._ChunkEnd !== this.UploadItem.GetSize();
            }, /**
             *
             * @param {XMLHttpRequest} oXhr
             * @param {object} oEvent
             * @private
             */
            _LoadHandler: function(oXhr, oEvent) {
                if (this.UploadItem) {
                    ...
                    var oResponse = this._CreateResponse(oXhr);
                    var oEventData = new ITHit.WebDAV.Client.Upload.Events.LoadEnd(this.UploadItem, oResponse);
                    ITHit.Events.DispatchEvent(this, oEventData.Name, [this, oEventData]);
                }
            },
...
(function() {
    ...
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Providers.UploadTask',
        null,
        /** @lends ITHit.WebDAV.Client.Upload.Providers.UploadTask.prototype */
        {

            /**
             * Uploader associated with task.
             * @public
             * @type {ITHit.WebDAV.Client.Upload.Uploaders.BaseXhrUploader}
             */
            Uploader: null,
            ...
            /**
             * @classdesc This class links {@link ITHit.WebDAV.Client.Upload.UploadItem}
             * with {@link ITHit.WebDAV.Client.Upload.Uploaders.BaseXhrUploader}
             * and provide addition data for upload process.
             * @class ITHit.WebDAV.Client.Upload.Providers.UploadTask
             * @constructs
             * Create new task.
             * @param {ITHit.WebDAV.Client.Upload.Uploaders.BaseXhrUploader} oUploader The uploader for upload processing.
             * @param {ITHit.WebDAV.Client.Upload.UploadItem} oUploadItem the item to uploader works on.
             * @param {ITHit.WebDAV.Client.Upload.Providers.ProgressTracker} oProgressTracker
             * @public
             */
            constructor: function(oUploader, oUploadItem, oProgressTracker) {
                this.Uploader = oUploader;
                this.UploadItem = oUploadItem;
                this.ProgressTracker = oProgressTracker;
            }
        });
})();
...
(function() {
    ...
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.UploaderSession',
        ...
        /** @lends ITHit.WebDAV.Client.Upload.UploaderSession.prototype */{
             ...
             * @return {ITHit.WebDAV.Client.Request} Request object.
             */
            GetProgressReportAsync: function(sUrl, fCallback) {
             ...
             * @return {ITHit.WebDAV.Client.Request} Request object.
             */
            CheckExistsAsync: function(sUrl, fCallback) {
                fCallback = fCallback || function() {};
...
(function() {
    /**
     *
     * @class ITHit.WebDAV.Client.Upload.Uploaders.WebKitUploader
     * @extends ITHit.WebDAV.Client.Upload.Uploaders.BaseXhrUploader
     */
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Uploaders.WebKitUploader',
        ITHit.WebDAV.Client.Upload.Uploaders.BaseXhrUploader,
        /** @lends ITHit.WebDAV.Client.Upload.Uploaders.WebKitUploader.prototype */
        {
...
(function() {
    ...
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Uploaders.FolderUploader',
        ITHit.WebDAV.Client.Upload.Uploaders.BaseUploader,
        /** @lends ITHit.WebDAV.Client.Upload.Uploaders.FolderUploader.prototype */
        {
             ...
             * @public
             * @classdesc Class represent Folder Uploader.
             * @class ITHit.WebDAV.Client.Upload.Uploaders.FolderUploader
             * @constructs
            ...
            _DispatchLoadStart: function() {
                var oEventData = new ITHit.WebDAV.Client.Upload.Events.LoadStart(this.UploadItem, 0, 0);
                ITHit.Events.DispatchEvent(this, oEventData.Name, [
                    this,
                    oEventData]);
            },
            _DispatchLoadEnd: function() {
                var oEventData = new ITHit.WebDAV.Client.Upload.Events.LoadEnd(this.UploadItem, null);
                ITHit.Events.DispatchEvent(this, oEventData.Name, [
                    this,
                    oEventData]);
            },
            ...
            BeginUpload: function(oUploadItem, iStartPosition) {
                ...
                var that = this;
                if(oUploadItem._FileInfo.IsExists) {
                    that._DispatchProgressChanged();
                    that._DispatchLoadEnd();
                    return;
                }
                this._Session.CreateFolderAsync(this.Url, null, function(oAsyncResult) {
                    if (!oAsyncResult.IsSuccess) {
                        that._DispatchProgressChanged();
                        that._DispatchError(oAsyncResult.Status, oAsyncResult.Error);
                    } else {
                        that._DispatchLoadEnd();
                    }
                });
            ...
            _DispatchError: function(oStatus, oError) {
                var oEventData = new ITHit.WebDAV.Client.Upload.Events.LoadError(this, oStatus, oError);
                ITHit.Events.DispatchEvent(this, oEventData.Name, [this, oEventData]);
            },


            _DispatchProgressChanged: function() {
                var oEventData = new ITHit.WebDAV.Client.Upload.Events.LoadProgress(this.UploadItem, 0, 0);
                ITHit.Events.DispatchEvent(this, oEventData.Name, [this, oEventData]);
            }
        });
})();
...
(function() {
    var staticSelf = ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Uploaders.CreateParentDecorator',
        ITHit.WebDAV.Client.Upload.Uploaders.BaseUploader,
        /** @lends ITHit.WebDAV.Client.Upload.Uploaders.CreateParentDecorator.prototype */
        {
            /**
             * @type {ITHit.WebDAV.Client.Upload.Uploaders.BaseUploader}
             */
            _Uploader: null,
            _PathsToCreate: [],
            /**
             ...
             * Creates new instance.
             * @public
             * @classdesc Class represent decorates uploader with folder creation logic.
             * @class ITHit.WebDAV.Client.Upload.Uploaders.CreateParentDecorator
             * @extends ITHit.WebDAV.Client.Upload.Uploaders.BaseUploader
             * @constructs
             * @param {ITHit.WebDAV.Client.Upload.UploaderSession} oSession
             * @param {ITHit.WebDAV.Client.Upload.Uploaders.BaseUploader} oUploader
             */
            constructor: function(oSession, oUploader) {
                this._Session = oSession;
                this._Uploader = oUploader;
            },
             ...
             */
            BeginUpload: function(oUploadItem, iStartPosition) {
                if (this.IsAborted || !this._Uploader) return;
                this._SubscribeOnEvents();
                var that = this;
                if (oUploadItem._FileInfo.IsExists) {

                    that._Uploader.BeginUpload(oUploadItem, iStartPosition);
                    that.UploadItem = that._Uploader.UploadItem;
                    that.Url = that._Uploader.Url;
                    return;
                }

                this._CreateMissedParentsAsync(oUploadItem, function(oAsyncResult) {
                    if (!oAsyncResult.IsSuccess || that.IsAborted || !that._Uploader) return;
                    that._Uploader.BeginUpload(oUploadItem, iStartPosition);
                    that.UploadItem = that._Uploader.UploadItem;
                    that.Url = that._Uploader.Url;
                });
            ...
            _ForwardEventStart: function(oSender, oEventData) {
                ITHit.Events.DispatchEvent(this, oEventData.Name, [oSender, oEventData]);
            },

            _GetAncestorsPaths: function(oUploadItem) {
                var sRelativePath = oUploadItem.GetRelativePath();
                var parts = sRelativePath.split('/');
                if (oUploadItem.IsFolder()) parts = parts.slice(0, -1);
                var aUrlToProcess = [];
                if (parts.length > 1) {
                    var path = '';
                    for (var i2 = 0; i2 < parts.length - 1; i2++) {
                        if (path !== '') path += '/';
                        path += parts[i2];
                        aUrlToProcess.push(oUploadItem.GetBaseUrl() + path);
                    }
                }
                return aUrlToProcess;
            },
            _CreateMissedParentsAsync: function(oUploadItem, fCallback) {
                this._PathsToCreate = this._PathsToCreate.concat(this._GetAncestorsPaths(oUploadItem));
                this._CreatePathCollectionAsync(this._PathsToCreate, fCallback);
            },
            _CreatePathCollectionAsync: function(aUrl, fCallback) {
                if (aUrl.length > 0 && !this.IsAborted) {
                    var self = this;
                    var sFirstUrl = aUrl[0];
                    self._CreateFolderIfNotExists(sFirstUrl, function(oAsyncResult) {
                        if (oAsyncResult.IsSuccess) {
                            self._CreatePathCollectionAsync(aUrl.slice(1), function(oAsyncResult) {
                                if (oAsyncResult.IsSuccess) {
                                    fCallback(new ITHit.WebDAV.Client.AsyncResult(aUrl, true, null));
                                } else {
                                    fCallback(new ITHit.WebDAV.Client.AsyncResult(aUrl, false, oAsyncResult.Error));
                                }
                            });
                        } else {
                            fCallback(new ITHit.WebDAV.Client.AsyncResult(aUrl, false, oAsyncResult.Error));
            ...
            _CreateFolderIfNotExists: function(sUrl, fCallback) {
                if (this.IsAborted) {
                    fCallback(new ITHit.WebDAV.Client.AsyncResult(sUrl, true, null));
                    return;
                }

                var self = this;
                this._EnterUrlGuarded(sUrl, function() {
                    self._CurrentRequest = self._Session.CheckExistsAsync(sUrl, function(oAsyncResult) {
                        if (oAsyncResult.IsSuccess && !oAsyncResult.Result && !self.IsAborted) {
                            self._CurrentRequest = self._Session.CreateFolderAsync(sUrl, null, function(oAsyncResult) {
                                if (oAsyncResult.IsSuccess) {
                                    self._LeaveUrlGuarded(sUrl);
                                    fCallback(new ITHit.WebDAV.Client.AsyncResult(sUrl, true, null));
                                } else {
                                    self._LeaveUrlGuarded(sUrl);
                                    fCallback(new ITHit.WebDAV.Client.AsyncResult(sUrl, false, oAsyncResult.Error));
                                }
                            });
                        } else {
                            self._LeaveUrlGuarded(sUrl);
            ...
            _EnterUrlGuarded: function(sUrl, fCallback) {
                var aHandlers = staticSelf._UrlInProgress.Get(sUrl);
                if (aHandlers) {
                    aHandlers.push(fCallback);
                } else {
                    staticSelf._UrlInProgress.Set(sUrl, []);
                    setTimeout(fCallback, 0);
                }
            },
            _LeaveUrlGuarded: function(sUrl) {
                var aHandlers = staticSelf._UrlInProgress.Get(sUrl);
                if (aHandlers && aHandlers.length) {
                    var aHandler = aHandlers.pop();
                    setTimeout(aHandler, 0);
                } else {
                    staticSelf._UrlInProgress.Delete(sUrl);
                }
            }
        },
        /** @lends ITHit.WebDAV.Client.Upload.Uploaders.CreateParentDecorator */ {
            /**
             * @private
...
(function() {
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Uploaders.UploadersFactory',
        null,
        /** @lends ITHit.WebDAV.Client.Upload.Uploaders.UploadersFactory.prototype */
        {
            ...
            /**
             * @public
             * @class ITHit.WebDAV.Client.Upload.Uploaders.UploadersFactory
             * @classdesc Class provides method for creating uploaders.
             * @constructs
             * @param {ITHit.WebDAV.Client.Upload.UploaderSession} oSession
             */
            constructor: function(oSession) {
            ...
            /**
             * Create uploader from UploadItem.
             * @param {ITHit.WebDAV.Client.Upload.UploadItem} oUploadItem
             * @return {ITHit.WebDAV.Client.Upload.Uploaders.BaseUploader}
             */
            CreateFromUploadItem: function(oUploadItem){
                var oUploader = null;
                if (oUploadItem.IsFolder()) {
                    oUploader = new ITHit.WebDAV.Client.Upload.Uploaders.FolderUploader(this._Session);
                } else {
                    oUploader = new ITHit.WebDAV.Client.Upload.Uploaders.WebKitUploader();
                }

                return new ITHit.WebDAV.Client.Upload.Uploaders.CreateParentDecorator(this._Session, oUploader);
            }
...
(function() {
    ...
    /**
     * This class provides methods for performing and manage upload process.
     * @public
     * @class ITHit.WebDAV.Client.Upload.Providers.UploadProvider
     */
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Providers.UploadProvider',
        ...
        /** @lends ITHit.WebDAV.Client.Upload.Providers.UploadProvider.prototype */
        {
            ...
            /**
             * Collection of upload tasks.
             * @private
             * @type {Object.<string,ITHit.WebDAV.Client.Upload.Providers.UploadTask>}
             */
            _UploadTasks: null,

            /**
             * Number of upload tasks.
             * @public
             * @type {number}
             */
            UploadCounter: 0,
             ...
             * @param {string} sUrl
             * @param {number} iSize Size of item to upload.
             */
            CreateProgressTracker: function(sUrl, iSize) {
                return new ITHit.WebDAV.Client.Upload.Providers.ProgressTracker(this._Session, sUrl, iSize);
            },
            ...
            /**
             * @type {ITHit.WebDAV.Client.Upload.Uploaders.UploadersFactory}
             */
            ...
            _SubscribeOnUploaderEvents: function(oUploader) {
                ITHit.Events.AddListener(oUploader, ITHit.WebDAV.Client.Upload.Events.EventName.OnLoadStart, '_LoadStartHandler', this);
                ITHit.Events.AddListener(oUploader, ITHit.WebDAV.Client.Upload.Events.EventName.OnLoadProgress, '_ProgressHandler', this);
                ITHit.Events.AddListener(oUploader, ITHit.WebDAV.Client.Upload.Events.EventName.OnLoadEnd, '_LoadHandler', this);
                ITHit.Events.AddListener(oUploader, ITHit.WebDAV.Client.Upload.Events.EventName.OnLoadError, '_ErrorHandler', this);
            },
            _OnUploadSessionStart: function(oUploadItem, oUploadTask) {
                oUploadItem._SetState(ITHit.WebDAV.Client.Upload.State.Uploading);
                if (oUploadTask.ProgressTracker.IsUploaded()) {
                    oUploadTask.ProgressTracker.Reset();
                }
                var oUploader = this._UploadersFactory.CreateFromUploadItem(oUploadItem);
                oUploadTask.Uploader = oUploader;
                this._SubscribeOnUploaderEvents(oUploader);
                oUploader.BeginUpload(oUploadItem);
            },
             ...
             * @param {ITHit.WebDAV.Client.Upload.Providers.ProgressTracker} oProgressTracker
             */
            StartUploadAsync: function(oUploadItem, oProgressTracker, fCallback) {
                var oPreviousState = oUploadItem.GetState();
                if (oPreviousState === ITHit.WebDAV.Client.Upload.State.Uploading) return;
                var oUploadTask = new ITHit.WebDAV.Client.Upload.Providers.UploadTask(null, oUploadItem, oProgressTracker);
                this._UploadTasks[oUploadItem.GetUrl()] = oUploadTask;
                this.UploadCounter++;
                if (oUploadItem._FileInfo.IsExists) {
                    var that = this;
                    oUploadTask.ProgressTracker.StartResumableSessionAsync(function() {
                        that._OnUploadSessionStart(oUploadItem, oUploadTask);
                    });
                } else {
                    oUploadTask.ProgressTracker.StartTracking();
                    this._OnUploadSessionStart(oUploadItem, oUploadTask);
                }
            ...
            /**
             * Find task by upload item.
             * @param {ITHit.WebDAV.Client.Upload.UploadItem} oUploadItem
             * @return {ITHit.WebDAV.Client.Upload.Providers.UploadTask}
             * @private
             */
            _GetTaskByItem: function(oUploadItem) {
                var sUrl = oUploadItem.GetUrl();
                return this._UploadTasks[sUrl];
            },

            /**
             * @param {ITHit.WebDAV.Client.Upload.Uploaders.WebKitUploader} oUploader
             * @param {ITHit.WebDAV.Client.Upload.Events.LoadStart} oEventData
             * @private
             */
            _LoadStartHandler: function(oUploader, oEventData) {
                var oTask = this._GetTaskByItem(oUploader.UploadItem);
                oTask.IsStarted = true;
            },

            /**
             *
             * @param {ITHit.WebDAV.Client.Upload.Uploaders.WebKitUploader} oUploader
             * @param {ITHit.WebDAV.Client.Upload.Events.LoadProgress} oEventData
             * @private
             */
            _ProgressHandler: function(oUploader, oEventData) {
                var oUploadTask = this._GetTaskByItem(oUploader.UploadItem);
                if (!oUploadTask) {
                    return;
                }
                oUploadTask.ProgressTracker.UpdateBytes(oEventData.BytesLoaded, oEventData.TotalBytes);
            },
            /**
             *
             * @param {ITHit.WebDAV.Client.Upload.Uploaders.WebKitUploader} oUploader
             * @param {ITHit.WebDAV.Client.Upload.Events.LoadEnd} oEventData
             * @private
             */
            _LoadHandler: function(oUploader, oEventData) {
                this.ProgressTracker.UpdateBytes(oEventData.Item.GetSize(), oEventData.Item.GetSize());
                this._FinaliseUploadAsync(oUploader.UploadItem, function() {
                    oUploader.UploadItem._SetState(ITHit.WebDAV.Client.Upload.State.Completed);
                });
            },
             ...
             *
             * @param {ITHit.WebDAV.Client.Upload.Uploaders.WebKitUploader} oUploader
             * @param {ITHit.WebDAV.Client.Upload.Events.LoadError} oLoadError
             * @private
             */
            _ErrorHandler: function(oUploader, oLoadError) {
                var oUploadTask = this._GetTaskByItem(oUploader.UploadItem);
                if (!oUploadTask) {
                    return;
                }
                ...
                this._FinaliseUploadAsync(oUploader.UploadItem, function() {
                    oUploadTask.UploadItem._SetState(ITHit.WebDAV.Client.Upload.State.Failed);
                });
            },
             ...
             */
            _FinaliseUploadAsync: function(oUploadItem, fCallback) {
                var oUploadTask = this._GetTaskByItem(oUploadItem);
                if (!oUploadTask) {
                    fCallback();
                }

                if (oUploadTask.Uploader) {
                    ITHit.Events.RemoveAllListeners(oUploadTask.Uploader);
                    oUploadTask.Uploader.Destruct();
                }
                var that = this;

                if(oUploadItem.GetState() !== ITHit.WebDAV.Client.Upload.State.Uploading) {
                    oUploadTask.ProgressTracker.StopResumableSessionAsync(function(){
                        delete that._UploadTasks[oUploadItem.GetUrl()];
                        that.UploadCounter--;
                        fCallback();
                    });
                } else {
                    oUploadTask.ProgressTracker.StopTracking();
                    delete that._UploadTasks[oUploadItem.GetUrl()];
                    that.UploadCounter--;
                    fCallback();
                }
            ...
            PauseUpload: function(oUploadItem, fCallback) {
                if (oUploadItem.GetState() !== ITHit.WebDAV.Client.Upload.State.Uploading) return;
                var oUploadTask = this._GetTaskByItem(oUploadItem);
                if (!oUploadTask) {
                    fCallback();
                    return;
                }
                this._FinaliseUploadAsync(oUploadItem, function() {
                        oUploadItem._SetState(ITHit.WebDAV.Client.Upload.State.Paused);
                        fCallback();
                    });
            },
             ...
             * @param {Function} fCallback
             */
            _AbortNotStartedUpload: function(oUploadItem, fCallback) {
                oUploadItem._SetState(ITHit.WebDAV.Client.Upload.State.Canceled);
                oUploadItem._ProgressTracker.Reset();
                fCallback();
            },
             ...
             * @param {Function} fCallback
             */
            OnAbortRequestFinalised: function(oUploadItem, iTryCount, iRepeatTime, fCallback) {
                var that = this;
                if (!oUploadItem._FileInfo.IsExists) {
                    ...
                    var oRepeatable = new ITHit.WebDAV.Client.Upload.Utils.RepeatableAction(function(oContext) {
                        that._Session.DeleteAsync(oUploadItem.GetUrl(), null, function(oAsyncResult) {
                    ...
                    oRepeatable.RunAsync(iTryCount, iRepeatTime, function(oResult) {
                        if (!!oResult && oResult.IsSuccess) {
                            oUploadItem._SetState(ITHit.WebDAV.Client.Upload.State.Canceled);
                        } else {
                            oUploadItem._SetState(ITHit.WebDAV.Client.Upload.State.Failed);
                        }
                        oUploadItem._ProgressTracker.Reset();
                        fCallback();
                    });
                ...
                that._Session.CancelUploadAsync(oUploadItem.GetUrl(), function(oAsyncReslt) {
                    oUploadItem._SetState(ITHit.WebDAV.Client.Upload.State.Canceled);
                    oUploadItem._ProgressTracker.Reset();
                    fCallback();
                });
             ...
             * @param {Function} fCallback
             */
            AbortUpload: function(oUploadItem, iTryCount, iRepeatTime, fCallback) {
                fCallback = fCallback || function(){};
                var oUploadTask = this._GetTaskByItem(oUploadItem);
                var sState = oUploadItem.GetState();
                if (sState == ITHit.WebDAV.Client.Upload.State.Paused || sState == ITHit.WebDAV.Client.Upload.State.Failed) {
                    this.OnAbortRequestFinalised(oUploadItem, iTryCount, iRepeatTime, fCallback);
                } else if (!oUploadTask) {
                    this._AbortNotStartedUpload(oUploadItem, fCallback);
                } else {
                    var that = this;
                    this._FinaliseUploadAsync(oUploadItem, function() {
                        if (oUploadTask.IsStarted) {
                            that.OnAbortRequestFinalised(oUploadItem, iTryCount, iRepeatTime, fCallback);
                        } else {
                            that._AbortNotStartedUpload(oUploadItem, fCallback);
                        }
                    });
                }
            }
...
(function() {
    ...
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Queue',
        ...
        /** @lends ITHit.WebDAV.Client.Upload.Queue.prototype */ {
            ...
            /**
             * @param {ITHit.WebDAV.Client.Upload.UploadInfo} oUploadInfo
             * @return {boolean}
             */
            ShouldReplaceDuplicate: function(oUploadInfo) {
                var oUpload = this.GetByUrl(oUploadInfo.Url.GetHref());
                var sState = oUpload.GetState();
                return !(sState ===
            ...
            _FillExistence: function(aUploadInfos, fCallback) {
                ITHit.WebDAV.Client.Upload.Utils.Array.MapParallel(aUploadInfos,
                    function(oEntry, iIndex, aArray, fDone) {
                        this._Session.CheckExistsAsync(oEntry.Url.GetHref(), function(oAsyncResult) {
                            if (!oAsyncResult.IsSuccess ||
                                !oAsyncResult.Result) {
                                oEntry.IsExists = false;
                            } else {
                                oEntry.IsExists = true;
                            }
                            fDone(oEntry);
                        });
                    },
            ...
            /**
             * Adds {@link ITHit.WebDAV.Client.Upload.UploadInfo}s to the queue. And begins processing based on settings.
             * @private
             * @param {ITHit.WebDAV.Client.Upload.UploadInfo[]} aUploadInfos Items to add.
             * @param {ITHit.WebDAV.Client.Upload.Controls.HtmlControl} [oSource] Source of items.
             */
            AddFilesToQueue: function(aUploadInfos, oSource) {
                var that = this;
                this._FillExistence(aUploadInfos, function(aInfos){
                    var aPrepareFilesToUpload = [];
                    for (var i = 0; i < aInfos.length; i++) {
                        var oUploadInfo = aInfos[i];
                        if (that.HasUrl(oUploadInfo.Url.GetHref()) ) {
                            if (that.ShouldReplaceDuplicate(oUploadInfo)) {
                                that.RemoveByUrl(oUploadInfo.Url.GetHref());
                            } else continue;
                        }
                        var oUploadItem = new ITHit.WebDAV.Client.Upload.UploadItem(that, oUploadInfo, oSource, that._UploadProvider);
                        aPrepareFilesToUpload.push(oUploadItem);
                    }

                    that.AddRange(aPrepareFilesToUpload);
                });
            },

            /**
             * Adds {@link ITHit.WebDAV.Client.Upload.UploadInfo} to the queue.
             * @private
            ...
            Add: function(oUploadItem) {
                ...
                oUploadItem.AddListener(ITHit.WebDAV.Client.Upload.Events.EventName.OnStateChanged, '_TryStartNewUpload', this);
            ...
            /**
             * Adds {@link ITHit.WebDAV.Client.Upload.UploadInfo}s collection to the queue.
            ...
            AddRange: function(aUploadItems) {
                for (var i = 0; i < aUploadItems.length; i++) {
                    ...
                    oUploadFile.AddListener(ITHit.WebDAV.Client.Upload.Events.EventName.OnStateChanged, '_TryStartNewUpload', this);
                }
            ...
            RemoveByUrl: function(sUrl) {
                ...
                if(currentState === ITHit.WebDAV.Client.Upload.State.Uploading ||
                    ...
                    this._UploadProvider.AbortUpload(oUploadItem);
                }
            ...
            _TryStartNewUpload: function() {
                if (this._UploadProvider.UploadCounter < this.Uploader.Settings.ConcurrentUploads) {
                    var oUploadItem = this.GetFirstByState(ITHit.WebDAV.Client.Upload.State.Queued);
                    if (oUploadItem) {
            ...
            /**
             * Get first uploading with specified state.
             * @private
             * @param {(ITHit.WebDAV.Client.Upload.State | string)} oState The state to test.
             * @return {ITHit.WebDAV.Client.Upload.UploadItem|undefined}
             */
            GetFirstByState: function(oState) {
                return ITHit.Utils.FindBy(this._UnderlyingArray,
                    function(oElement) {
                        return oElement.GetState() === oState;
                    });
            },
...
(function() {
     ...
     */
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.DropZoneCollection',
        null,
        /** @lends ITHit.WebDAV.Client.Upload.DropZoneCollection.prototype */
        {
            ...
            AddById: function(sElementId) {
                ...
                var oDropZone = new ITHit.WebDAV.Client.Upload.Controls.DropZone(this._Uploader, sElementId);
...
(function() {
     ...
     */
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.InputCollection',
        null,
        /** @lends ITHit.WebDAV.Client.Upload.InputCollection.prototype */{
             ...
             */
            AddById: function(sElementId) {
                var oInput = new ITHit.WebDAV.Client.Upload.Controls.Input(this._Uploader, sElementId);
...
(function() {
    ITHit.DefineClass('ITHit.WebDAV.Client.Upload.Settings',
        ...
        /** @lends ITHit.WebDAV.Client.Upload.Settings.prototype */
        {
             ...
             * @default ITHit.WebDAV.Client.Upload.State.Uploading
             */
