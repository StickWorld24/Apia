...
function processXmlEnvParams(){
	...
	if (ajaxCallXml != null && ajaxCallXml.getElementsByTagName("envParameters")[0].getElementsByTagName("envParam")) {
		...
		if (envParameters[22] != null && envParameters[22].getAttribute("value") == "false") { //show document monitor
			disableField($('envParam24'));
		}
	}
}

function checkParam24() {
	var cmb = $('envParam23');
	var fieldId = ['envParam24'];
	enableDisableField(cmb, fieldId);
}
