...
// 		var GNR_PER_DAT_ING 	= '<system:label show="text" label="msgPerDatIng" forScript="true" />';	
		...
		var FUNCTION_DATE_WITHOUT_HOUR = '<system:edit show="constant" from="com.dogma.vo.QryColumnVo" field="FUNCTION_CURRENT_DATE_WITHOUT_HOUR"/>';
		...
		var lblQryFunDteWH	= '<system:label show="text" label="lblQryFunDteWH" forScript="true" />';
