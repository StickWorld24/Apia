...
//		label.appendText(this.xml.getAttribute("attLabel") + ':');
		...
		spanLabel.addClass("multipleSelectLabel");
		...
		multiple.set('data-position',inputsCount++);
	...
	showFormListener: function() {
		if(this.HTMLselect)
			this.HTMLselect.erase('data-disabledCheck');
	},
	
	hideFormListener: function() {
		if(this.HTMLselect)
			this.HTMLselect.set('data-disabledCheck', 'true');
	}
});