...
var params = {
	...
	lblSignWrongVersion: "<%
		...
		toks.add("<a href='apiaDigitalSignatureEdgeInstaller.jar' download>");
		toks.add("</a>");
...
setInterval(function() {
	...
	if(div && !div.get('processed')) {
		div.addEvent('keydown', function(e) {
 		...
 		out.write(StringUtil.parseMessage(LabelManager.getName(uData,"msgVerifyEnabEdgeExt"), toks) + "<br/>");
 		
 		toks = new ArrayList<String>();
 		toks.add("<a href=\"sasa\" target=\"_blank\">");
 		toks.add("</a>");
 			
 		out.write(StringUtil.parseMessage(LabelManager.getName(uData,"msgVerifyInstEdgeExt"), toks) + "<br/>");
